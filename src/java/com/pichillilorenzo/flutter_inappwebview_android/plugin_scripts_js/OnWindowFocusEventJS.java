...
{
    public static final PluginScript ON_WINDOW_FOCUS_EVENT_JS_PLUGIN_SCRIPT;
    ...
    static {
        ON_WINDOW_FOCUS_EVENT_JS_PLUGIN_SCRIPT = new PluginScript("IN_APP_WEBVIEW_ON_WINDOW_FOCUS_EVENT_JS_PLUGIN_SCRIPT", "(function(){  window.addEventListener('focus', function(e) {    window.flutter_inappwebview.callHandler('onWindowFocus');  });})();", UserScriptInjectionTime.AT_DOCUMENT_START, null, false, null);
    }
}
