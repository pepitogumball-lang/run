...
public class JsBeforeUnloadResponse
{
    ...
    public JsBeforeUnloadResponse(final String message, final String confirmButtonTitle, final String cancelButtonTitle, final boolean handledByClient, final Integer action) {
    ...
    public static JsBeforeUnloadResponse fromMap(final Map<String, Object> map) {
        if (map == null) {
            return null;
        }
        return new JsBeforeUnloadResponse((String)map.get((Object)"message"), (String)map.get((Object)"confirmButtonTitle"), (String)map.get((Object)"cancelButtonTitle"), (boolean)map.get((Object)"handledByClient"), (Integer)map.get((Object)"action"));
    }
    ...
    public boolean equals(final Object o) {
        ...
        final JsBeforeUnloadResponse jsBeforeUnloadResponse = (JsBeforeUnloadResponse)o;
        ...
        Label_0077: {
            if (message != null) {
                if (message.equals((Object)jsBeforeUnloadResponse.message)) {
                    break Label_0077;
                }
            }
            else if (jsBeforeUnloadResponse.message == null) {
                break Label_0077;
            }
            return false;
        }
        ...
        Label_0109: {
            if (confirmButtonTitle != null) {
                if (confirmButtonTitle.equals((Object)jsBeforeUnloadResponse.confirmButtonTitle)) {
                    break Label_0109;
                }
            }
            else if (jsBeforeUnloadResponse.confirmButtonTitle == null) {
                break Label_0109;
            }
            return false;
        }
        ...
        Label_0141: {
            if (cancelButtonTitle != null) {
                if (cancelButtonTitle.equals((Object)jsBeforeUnloadResponse.cancelButtonTitle)) {
                    break Label_0141;
                }
            }
            else if (jsBeforeUnloadResponse.cancelButtonTitle == null) {
                break Label_0141;
            }
            return false;
        }
        final Integer action = this.action;
        final Integer action2 = jsBeforeUnloadResponse.action;
        if (action != null) {
