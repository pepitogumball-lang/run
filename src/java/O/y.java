...
public final class y extends RadioButton
{
    public final k C;
    public final Zr D;
    public final u0 E;
    ...
    public y(final Context context, final AttributeSet set) {
        c1.a(context);
        super(context, set, 2130903524);
        b1.a(((View)this).getContext(), (View)this);
        (this.C = new k((TextView)this)).c(set, 2130903524);
        (this.D = new Zr((View)this)).d(set, 2130903524);
        (this.E = new u0((TextView)this)).f(set, 2130903524);
        this.getEmojiTextViewHelper().b(set, 2130903524);
    }
